...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO MY API ZEUX🔥!') // boleh diubah
}
...
var creator = 'JoJo XD' // ubah jadi nama lu
const listkey = ["ZeuxBOT","JoJo","JoJo -XD"]; // ubah apikey nya, tambah aja klo mau
